...
type UserRepoContract interface {
	...
	UpdateSelfProfileTx(ctx context.Context, t tx.Tx, userID string, model entity.UserUpdate) (*entity.UserEntity, *app_errors.AppError)
	DeactivateSelfUser(ctx context.Context, t tx.Tx, userID string) (bool, *app_errors.AppError)
}
